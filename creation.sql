...
-- Table 1
CREATE TABLE IF NOT EXISTS T7_INCIDENT
(
...
CREATE UNIQUE INDEX XPKINCIDENT_17 ON T7_INCIDENT (Incident_Id ASC);
-- Table 2
-- cust_id = 50201...50220
...
CREATE UNIQUE INDEX XPKCUSTOMER_1 ON T7_CUSTOMER (Cust_Id ASC);

-- Table 3
CREATE TABLE IF NOT EXISTS T7_INCIDENT_REPORT
(
...
CONSTRAINT R_83 FOREIGN KEY (Incident_Id) REFERENCES T7_INCIDENT (Incident_Id), 
CONSTRAINT R_86 FOREIGN KEY (Cust_Id) REFERENCES T7_CUSTOMER (Cust_Id)
);
CREATE UNIQUE INDEX XPKINCIDENT_REPORT_18 ON T7_INCIDENT_REPORT (Incident_Report_Id ASC,Incident_Id ASC,Cust_Id ASC);

-- Table 4
CREATE TABLE IF NOT EXISTS T7_INSURANCE_COMPANY
(
...
CREATE UNIQUE INDEX XPKINSURANCE_COMPANY_15 ON T7_INSURANCE_COMPANY
(Company_Name ASC);
-- Table 5
CREATE TABLE IF NOT EXISTS T7_DEPARTMENT
(
...
REFERENCES T7_INSURANCE_COMPANY (Company_Name)
);
CREATE UNIQUE INDEX XPKDEPARTMENT ON T7_DEPARTMENT
...
Company_Name) REFERENCES T7_DEPARTMENT (Department_Name,
Department_ID, Company_Name)
);
CREATE UNIQUE INDEX XPKVEHICLE_SERVICE ON T7_VEHICLE_SERVICE
...
CONSTRAINT R_92 FOREIGN KEY (Cust_Id) REFERENCES T7_CUSTOMER
(Cust_Id)
);
CREATE UNIQUE INDEX XPKVEHICLE_6 ON T7_VEHICLE (Vehicle_Id ASC,Cust_Id ASC);
...
CONSTRAINT R_85 FOREIGN KEY (Cust_Id) REFERENCES T7_CUSTOMER
(Cust_Id)
);
...
-- TABLE 9
CREATE TABLE IF NOT EXISTS T7_RECEIPT
(
Receipt_Id VARCHAR(20) NOT NULL ,
Time DATE NOT NULL ,
...
REFERENCES T7_PREMIUM_PAYMENT (Premium_Payment_Id, Cust_Id)
);
CREATE UNIQUE INDEX XPKRECEIPT_21 ON T7_RECEIPT (Receipt_Id ASC,Premium_Payment_Id ASC,Cust_Id ASC);
...
CONSTRAINT R_93 FOREIGN KEY (Cust_Id) REFERENCES T7_CUSTOMER
(Cust_Id)
);
...
CREATE TABLE IF NOT EXISTS T7_INSURANCE_POLICY
(
...
CONSTRAINT R_95 FOREIGN KEY (Application_Id, Cust_Id) REFERENCES T7_APPLICATION (Application_Id, Cust_Id)
);
CREATE UNIQUE INDEX XPKINSURANCE_POLICY_4 ON T7_INSURANCE_POLICY
...
REFERENCES T7_INSURANCE_POLICY (Agreement_id, Application_Id, Cust_Id)
);
...
-- TABLE 13
CREATE TABLE IF NOT EXISTS T7_MEMBERSHIP
(
...
CONSTRAINT R_91 FOREIGN KEY (Cust_Id) REFERENCES T7_CUSTOMER
(Cust_Id)
);
CREATE UNIQUE INDEX XPKMEMBERSHIP_12 ON T7_MEMBERSHIP
...
T7_INSURANCE_COMPANY (Company_Name)
);
CREATE UNIQUE INDEX XPKSTAFF_9 ON T7_STAFF (Staff_Id ASC,Company_Name ASC);
...
CREATE UNIQUE INDEX XPKNOK_14 ON T7_NOK (Nok_Id ASC,Agreement_id ASC,Application_Id ASC);

-- TABLE 17
CREATE TABLE IF NOT EXISTS T7_PRODUCT 
( 
...
CONSTRAINT R_107 FOREIGN KEY (Company_Name) REFERENCES T7_INSURANCE_COMPANY (Company_Name)
);
CREATE UNIQUE INDEX XPKPRODUCT_20 ON T7_PRODUCT (Product_Number ASC,Company_Name ASC);

-- TABLE 18
CREATE TABLE IF NOT EXISTS T7_OFFICE
(
...
CONSTRAINT R_104 FOREIGN KEY (Department_Name,Department_ID,Company_Name) REFERENCES T7_DEPARTMENT (Department_Name,Department_ID,Company_Name)
);
CREATE UNIQUE INDEX XPKOFFICE_11 ON T7_OFFICE (Office_Name ASC,Department_Name ASC,Company_Name ASC);

-- TABLE 19 
CREATE TABLE IF NOT EXISTS T7_COVERAGE 
( 
...
CREATE UNIQUE INDEX XPKCOVERAGE_19 ON T7_COVERAGE
(Coverage_Id ASC,Company_Name ASC);

-- TABLE 20

CREATE TABLE IF NOT EXISTS T7_INSURANCE_POLICY_COVERAGE 
( 
Agreement_id VARCHAR(20) NOT NULL , 
Application_Id VARCHAR(20) NOT NULL ,
Cust_Id VARCHAR(20) NOT NULL , 
...
CONSTRAINT R_88 FOREIGN KEY (Cust_Id) REFERENCES T7_CUSTOMER
(Cust_Id)
);
CREATE UNIQUE INDEX XPKCLAIM_7 ON T7_CLAIM
(Claim_Id ASC,Cust_Id ASC);

-- TABLE 22
CREATE TABLE IF NOT EXISTS T7_CLAIM_SETTLEMENT
(
...
CONSTRAINT R_90 FOREIGN KEY (Claim_Id, Cust_Id) REFERENCES T7_CLAIM
(Claim_Id, Cust_Id)
);
